...
| `lesson.md` | AI curriculum | 导学后、实验前完整阅读 | **主要知识输入**：从零解释概念、因果链、推导、例子、常见误解和实验前知识；不要求先自行搜索资料。 |
...
`tutorial.md` 是导学，`lesson.md` 是可直接学习的课程正文和主要知识输入；两者都由 AI 根据官方文档、论文和源码维护。`lesson.md` 不能只是提纲、结论或练习题，也不能把“请自行阅读官方文档”当作正文。`note.md` 是不可替代的个人理解：脚手架和 AI 不应以长篇正文覆盖它。
